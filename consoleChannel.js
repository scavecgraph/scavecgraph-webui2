...
function listenMessage(msg) {
    if ($.type(msg) === "string") {
        if(isBoolean(msg)){
            console.log("*** listenMessage CONSOLECHANNEL STRING MSSG : " + msg);            
            showOrHideIconTrack(msg);
        }
    } else {
        if(isBoolean(msg.data)){
            console.log("*** listenMessage CONSOLECHANNEL JSON MSSG : " + msg.data);            
...
function showOrHideIconTrack(collapse){
    console.log("*** SHOW OR HIDE ICON TRACK : " + collapse);
    var channelTbl = $("#channelTbl");
    var trackingTd= $("#trackingTd");
    var contentFrm = $("#contentFrm");
    if(collapse){
        //console.log("collapse IconBar : " + collapse);
        //console.log(collapse + " - A-H : " + $("#channelTbl").css("height") + " " + FINAL_TABLE_HEIGHT + " - " + $("#trackingTd").css("height") + " " + FINAL_TRACKBAR_HEIGHT + " - " + $("#contentFrm").css("height") + " - " + PARFITHEIGHT + " - " + FITHEIGHT + " - " + HEIGHT);
        $("#trackingTd").hide();
        $("#trackerTd").hide();
        $("#searchTd").hide();
        $("#rootTd").hide();
        //console.log(collapse + " - B-H : " + $("#channelTbl").css("height") + " " + FINAL_TABLE_HEIGHT + " - " + $("#trackingTd").css("height") + " " + FINAL_TRACKBAR_HEIGHT + " - " + $("#contentFrm").css("height") + " - " + PARFITHEIGHT + " - " + FITHEIGHT + " - " + HEIGHT);
        //contentFrm.css("backgroundColor","#ff0000");
        contentFrm.css("width", FINAL_TABLE_WIDTH + "px");
        contentFrm.css("height", FINAL_TABLE_HEIGHT + "px");
        //console.log(collapse + " - C-H : " + $("#channelTbl").css("height") + " " + FINAL_TABLE_HEIGHT + " - " + $("#trackingTd").css("height") + " " + FINAL_TRACKBAR_HEIGHT + " - " + $("#contentFrm").css("height") + " - " + PARFITHEIGHT + " - " + FITHEIGHT + " - " + HEIGHT);
    }else{
        //console.log("inflate IconBar : " + collapse);
        //console.log(collapse + " - A-H : " + $("#channelTbl").css("height") + " " + FINAL_TABLE_HEIGHT + " - " + $("#trackingTd").css("height") + " " + FINAL_TRACKBAR_HEIGHT + " - " + $("#contentFrm").css("height") + " - " + PARFITHEIGHT + " - " + FITHEIGHT + " - " + HEIGHT);
        $("#trackingTd").show();
        $("#trackerTd").show();
        $("#searchTd").show();
        $("#rootTd").show();
        //console.log(collapse + " - B-H : " + $("#channelTbl").css("height") + " " + FINAL_TABLE_HEIGHT + " - " + $("#trackingTd").css("height") + " " + FINAL_TRACKBAR_HEIGHT + " - " + $("#contentFrm").css("height") + " - " + PARFITHEIGHT + " - " + FITHEIGHT + " - " + HEIGHT);
        //contentFrm.css("backgroundColor","#00ff00");
        contentFrm.css("width", (FINAL_TABLE_WIDTH - FINAL_TRACKBAR_WIDTH - 5) + "px");
        contentFrm.css("height", (FINAL_TABLE_HEIGHT - FINAL_TRACKBAR_HEIGHT - 5) + "px");
        //console.log(collapse + " - C-H : " + $("#channelTbl").css("height") + " " + FINAL_TABLE_HEIGHT + " - " + $("#trackingTd").css("height") + " " + FINAL_TRACKBAR_HEIGHT + " - " + $("#contentFrm").css("height") + " - " + PARFITHEIGHT + " - " + FITHEIGHT + " - " + HEIGHT);        
...
function buildUI() {
    ...
    if (fitWidth != null && fitWidth != "") {
        ...
        WIDTH = fitWidth;
        console.log('SETWIDTH : ' + PARFITWIDTH + ' - ' + WIDTH);
    }else{
        PARFITWIDTH = WIDTH;
    }
    if (fitHeight != null && fitHeight != "") {
        ...
        HEIGHT = fitHeight;
        console.log('SETHEIGHT : ' + PARFITHEIGHT + ' - ' + HEIGHT);
    }else{
        PARFITHEIGHT = HEIGHT;
    }

    console.log('buildUI : ' + PARFITWIDTH + ' - ' + WIDTH + ' - ' + PARFITHEIGHT + ' - ' + HEIGHT);
...
//    injectCSS(styleSupport2);
    ...
    //alert("3 WIDTH : " + WIDTH + " - HEIGHT : " + HEIGHT);
    getRootContexts();
    configureUI();
}
...
function autoScale() {
    ...
    console.log('autoScale : ' + WIDTH + ' - ' + HEIGHT);
...
function configureUI() {
    ...
    console.log('configureUI : ' + PARFITWIDTH + ' - ' + WIDTH + ' - ' + PARFITHEIGHT + ' - ' + HEIGHT);
...
function viewContextSvg(contextId, addViewContextIcon, clearContextIcons) {
    console.log('VIEW SVG : ' + SCALEFITWIDTH + ' - ' + SCALEFITHEIGHT);
//    alert("rootTd : " + $('[id=rootTd]').length + " - trackingTd : " + $('[id=trackingTd]').length);
    if (contextId != null && contextId != "") {
        CURRENTCONTEXT = contextId;
    }
    if(window.postMessage){
        //alert("Channel Parent : " + window.parent);
...
//        alert('VIEW SVG : ' + SCALEFITWIDTH + ' = ' + PARFITWIDTH + ' - ' + $("#rootTd").width() + ' , ' + SCALEFITHEIGHT + ' = ' + PARFITHEIGHT + ' - ' + $("#trackingTd").height() + ' ' + CURRENTCONTEXT);
        if (window.matchMedia("(pointer: coarse)").matches) {
            // MOBILE
